...
const allowedMarkdown = new Set([
  ...
  "reports/latest-book-alignment-audit.md",
  ...
  "reports/latest-universe-data-completion.md",
  ...
  "reports/latest-price-validation-queue.md",
  "reports/latest-short-history-refresh.md",
